// Orb component converted from React to vanilla JavaScript
class Orb {
    constructor(container, options = {}) {
        ...
        this.options = {
            ...
            rotateOnHover: options.rotateOnHover !== false,
    ...
    startAnimation() {
        ...
        const update = (t) => {
            ...
            // Update uniforms
            this.gl.uniform1f(this.uniforms.iTime, t * 0.001);
            ...
            this.hoverValue += (effectiveHover - this.hoverValue) * 0.1;
            this.gl.uniform1f(this.uniforms.hover, this.hoverValue);
